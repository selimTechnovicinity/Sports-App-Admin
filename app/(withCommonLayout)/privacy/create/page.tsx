...
import { createPrivacy, getPrivacy } from "@/lib/api";
...
const EditPrivacyPolicy = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await createPrivacy(privacyData);
      if (res?.message) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="max-w-3xl w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
        ...
        <div className="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow-sm">
          ...
          {/* Editor Area */}
          <EditorContent
            className="border rounded-sm dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600"
            editor={editor}
          />
        </div>
